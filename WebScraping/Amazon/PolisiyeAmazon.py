...
while True:
    sayfa_url = f'https://www.amazon.com.tr/s?i=stripbooks&rh=n%3A13808217031&s=popularity-rank&fs=true&page={sayfa_no}&qid=1743417077&xpid=mr91kpm8T5_At&ref=sr_pg_{sayfa_no}'
...
with open('polisiye_amazon.json', 'w', encoding='utf-8') as f:
    json.dump(kitap_list, f, ensure_ascii=False, indent=4) #ensure_ascii=False; Türkçe karakterlerin olduğu gibi yazılmasını sağlar. True olsaydı ASCII'ye çevirip yazdırırdı.