...
while True:
    sayfa_url = f'https://www.amazon.com.tr/s?i=stripbooks&rh=n%3A13808229031&s=popularity-rank&fs=true&page={sayfa_no}&qid=1743440065&xpid=bmn0W3qch91J1&ref=sr_pg_{sayfa_no}'
...
with open('cocuk_amazon.json', 'w', encoding='utf-8') as f:
